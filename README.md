# Code for "Impurity States in Altermagnetic Superconductors"
...
- `bulk` contains the code for Fig. 1(b)-(d) in the paper and Fig.S1 in the Supplemental Material.
- `tightbinding` contains the code for Figs. 2-5 and Figs.S2-S3 in the Supplemental Material.